...
export const ConfigForm: React.FC<ConfigFormProps> = ({
    ...
    if (!schema) {
        return <div className="text-muted-foreground p-4 text-sm">No configuration schema defined.</div>;
    }
    ...
    return <div className="text-muted-foreground p-4 text-sm">No configuration fields defined.</div>;
};
