...
describe('admin\seo\schema-markup', () => {
  beforeEach(() => {
    resetAllMocks()
  })
  ...
  it('returns 401 for unauthorized requests', async () => {
    ...
    const req = new NextRequest('http://localhostadmin\seo\schema-markup')

    // Test first available method
    const { GET } = await import('@/app/apiadmin\seo\schema-markup/route')
    if (GET) {
