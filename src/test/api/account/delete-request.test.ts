...
describe('account\delete-request', () => {
  beforeEach(() => {
    resetAllMocks()
  })
  ...
  it('returns 401 for unauthorized requests', async () => {
    ...
    const req = new NextRequest('http://localhostaccount\delete-request')

    // Test first available method
    const { GET } = await import('@/app/apiaccount\delete-request/route')
    if (GET) {
