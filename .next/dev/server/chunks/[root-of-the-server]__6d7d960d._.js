...
"[project]/src/app/api/admin/cms/pages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [pages, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.findMany({
                where,
                skip,
                take: limit,
                orderBy: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.count({
                where
            })
        ]);
...
async function POST(request) {
    try {
        ...
        const { title, slug, content, description, status, useStorefrontLayout, useBlockEditor, seoTitle, seoDescription, seoKeywords, ogImage, ogTitle, ogDescription, publishedAt, scheduledPublishAt, layoutConfig, customCss, customJs, templateId, authorId, conversionGoal, overridesStorefrontPage, overriddenPageType } = body;
        if (!title || !slug) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Missing required fields: title and slug', {
                status: 400
            });
        }
        // Content is optional if useBlockEditor is true
        if (!useBlockEditor && !content) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Content is required when not using block editor', {
                status: 400
            });
        }
        // Validate override fields
        if (overridesStorefrontPage && !overriddenPageType) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Page type is required when overriding storefront page', {
                status: 400
            });
        }
        ...
        if (overridesStorefrontPage && overriddenPageType) {
            ...
            if (expectedSlug !== undefined && slug !== expectedSlug) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`Slug must be "${expectedSlug}" for ${overriddenPageType} override`, {
                    status: 400
                });
            }
        }
        // Check if slug exists
        const existingPage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.findUnique({
            where: {
                slug
            }
        });
        if (existingPage) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Slug already exists', {
                status: 400
            });
        }
        // Check if another page already overrides this page type
        if (overridesStorefrontPage && overriddenPageType) {
            const existingOverride = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.findFirst({
                where: {
            ...
            if (existingOverride) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`Another page already overrides ${overriddenPageType}`, {
                    status: 400
                });
            }
        }
        const page = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.create({
            data: {
                title,
                slug,
                content: content || '',
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="87813038-aa79-53ca-9057-f866a6e48250")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__6d7d960d._.js.map
//# debugId=87813038-aa79-53ca-9057-f866a6e48250
