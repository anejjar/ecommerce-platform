...
async function POST(request) {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoiceSettings.findFirst();
        if (!settings) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const invoiceNumber = settings.invoiceNumberFormat.replace('{{prefix}}', settings.invoiceNumberPrefix).replace('{{number}}', settings.nextInvoiceNumber.toString().padStart(6, '0'));
        // Calculate totals
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoiceSettings.update({
            where: {
                id: settings.id
            },
            data: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].invoiceHistory.create({
            data: {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="db9d1d4d-1850-5a32-8392-bc31863506e9")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__5bc34dd5._.js.map
//# debugId=db9d1d4d-1850-5a32-8392-bc31863506e9
