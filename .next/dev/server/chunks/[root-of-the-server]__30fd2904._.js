...
async function PATCH(request, { params }) {
    try {
        ...
        const currentOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.findUnique({
            where: {
                id
            },
            select: {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.update({
            where: {
                id
            },
            data: json,
                ...
                if (customerEmail) {
                    if (status === 'SHIPPED') {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                            ...
                            html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orderShippedEmail"])(emailData, customerName, trackingNumber)
                        });
                    } else if (status === 'DELIVERED') {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                            to: customerEmail,
                            subject: `Your Order Has Been Delivered - ${order.orderNumber}`,
                            html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orderDeliveredEmail"])(emailData, customerName)
                        });
                    }
                }
            }
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="552d780e-b4e6-53fb-85f6-28570444c0bc")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__30fd2904._.js.map
//# debugId=552d780e-b4e6-53fb-85f6-28570444c0bc
