...
"[project]/src/app/api/products/[id]/reviews/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const existingReview = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.findUnique({
            where: {
                userId_productId: {
                    userId: user.id,
                    productId: id
        ...
        const hasPurchased = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].orderItem.findFirst({
            where: {
                productId: id,
                order: {
                    userId: user.id,
        ...
        try {
            ...
            if (adminEmail && product) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                    ...
                    html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminNewReviewEmail"])({
                        rating: review.rating,
                        title: review.title,
                        comment: review.comment,
                        verified: review.verified,
                        createdAt: review.createdAt
                    }, product.name, review.user.name || review.user.email || 'Anonymous', review.id)
                });
            }
        } catch (emailError) {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0ad20b06-b927-5643-84e5-392c33283eff")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__5881deb2._.js.map
//# debugId=0ad20b06-b927-5643-84e5-392c33283eff
