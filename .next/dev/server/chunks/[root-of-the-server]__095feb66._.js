...
"[project]/src/app/api/stock-alerts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const alerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].stockAlert.findMany({
            include: {
                product: {
                    select: {
                        id: true,
        ...
        const activeAlerts = alerts.filter((alert)=>alert.product.stock <= alert.threshold);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(activeAlerts);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="36f913e9-e9e0-5839-83f6-a0e285ff9a7f")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__095feb66._.js.map
//# debugId=36f913e9-e9e0-5839-83f6-a0e285ff9a7f
