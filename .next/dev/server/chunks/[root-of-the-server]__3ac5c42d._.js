...
"[project]/src/app/api/admin/export/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { id } = params;
        // Get export
        const dataExport = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dataExport.findUnique({
            where: {
                id
            },
            include: {
    ...
    try {
        ...
        if (dataExport.fileUrl) {
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].uploader.destroy(publicId, {
                    resource_type: 'raw'
                });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dataExport.delete({
            where: {
                id
            }
        });
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="c106ef94-fc9f-56f4-a693-5a97ffd33b84")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__3ac5c42d._.js.map
//# debugId=c106ef94-fc9f-56f4-a693-5a97ffd33b84
