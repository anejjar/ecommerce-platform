...
"[project]/src/app/api/admin/backup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [backups, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].backup.findMany({
                where,
                include: {
                    createdBy: {
                        select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].backup.count({
                where
            })
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        const { includeProducts = true, includeOrders = true, includeCustomers = true, includeMedia = false, includeSettings = true, type = 'MANUAL' } = body;
        // Create backup record
        const backup = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].backup.create({
            data: {
        ...
        setImmediate(async ()=>{
            try {
                ...
                // Export Customers
                if (includeCustomers) {
                    const customers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
                        where: {
                            role: 'CUSTOMER'
                        },
                        select: {
                ...
                // Export Settings
                if (includeSettings) {
                    const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].storeSetting.findMany();
                    backupData.data.settings = settings;
                    recordCount += settings.length;
                    const discountCodes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].discountCode.findMany();
                    backupData.data.discountCodes = discountCodes;
                    recordCount += discountCodes.length;
                    const featureFlags = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].featureFlag.findMany();
                    backupData.data.featureFlags = featureFlags;
                    recordCount += featureFlags.length;
                }
                // Export Media metadata (not files)
                if (includeMedia) {
                    const media = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].mediaLibrary.findMany({
                        include: {
                            folder: true,
                            tags: true,
                            variants: true
                ...
                const uploadResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].uploader.upload(`data:application/json;base64,${Buffer.from(jsonData).toString('base64')}`, {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].backup.update({
                    where: {
                        id: backup.id
                    },
                    data: {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="9a263012-cc24-52b9-b441-f0f59cbad289")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__a769a234._.js.map
//# debugId=9a263012-cc24-52b9-b441-f0f59cbad289
