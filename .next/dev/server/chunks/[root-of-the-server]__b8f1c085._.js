...
"[project]/src/app/api/admin/products/[id]/customization-fields/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        // Check permissions
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(session.user.role, 'PRODUCT', 'VIEW')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const fields = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productCustomizationField.findMany({
            where: {
                productId: id
            },
            include: {
...
async function POST(request, context) {
    try {
        ...
        // Check permissions
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(session.user.role, 'PRODUCT', 'UPDATE')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Insufficient permissions'
            }, {
                status: 403
        ...
        const { type, label, placeholder, helpText, required, minLength, maxLength, minValue, maxValue, pattern, maxFileSize, allowedTypes, priceModifier, priceModifierType, options } = body;
        ...
        // Validate field type
        const validTypes = Object.values(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["CustomizationFieldType"]);
        ...
        const maxPositionField = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productCustomizationField.findFirst({
            where: {
                productId: id
            },
            orderBy: {
        ...
        const field = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productCustomizationField.create({
            data: {
                productId: id,
                type,
                label,
                ...
                options: {
                    create: options && [
                        ...
                        'RADIO',
                        'CHECKBOX'
                    ].includes(type) ? options.map((option, index)=>({
                            label: option.label,
                            value: option.value,
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e4ffb2ff-b94c-5bce-b5d9-492e785fa45a")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__b8f1c085._.js.map
//# debugId=e4ffb2ff-b94c-5bce-b5d9-492e785fa45a
