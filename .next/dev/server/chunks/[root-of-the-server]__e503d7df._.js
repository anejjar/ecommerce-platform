...
"[project]/src/app/api/account/preferences/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const preferences = user.communicationPreferences ? JSON.parse(user.communicationPreferences) : {
            emailMarketing: true,
            smsMarketing: false,
            orderUpdates: true,
            promotions: true,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(preferences);
    } catch (error) {
...
async function PATCH(request) {
    try {
        ...
        const nonBooleanKeys = Object.entries(preferences).filter(([_, value])=>typeof value !== 'boolean').map(([key])=>key);
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e79e87d8-92ad-5c99-b786-ed2309280620")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__e503d7df._.js.map
//# debugId=e79e87d8-92ad-5c99-b786-ed2309280620
