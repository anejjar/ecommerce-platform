    ...
    try {
        ...
        for (const row of rows){
            try {
                ...
                const sku = row.SKU;
                if (sku) {
                    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findUnique({
                        where: {
                            sku
                        }
                    });
                ...
                let counter = 1;
                // Ensure unique slug
                while(await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findUnique({
                    where: {
                        slug: finalSlug
                    }
                })){
                ...
                if (imageUrl && product.id) {
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productImage.create({
                            data: {
                                url: imageUrl,
                                alt: name,
                                position: 0,
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e07a80b3-855d-52b4-b744-d3fb26930223")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__dfe1a11d._.js.map
//# debugId=e07a80b3-855d-52b4-b744-d3fb26930223
