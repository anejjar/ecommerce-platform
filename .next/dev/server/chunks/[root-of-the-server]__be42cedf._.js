...
"[project]/src/app/api/admin/cities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const cities = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].city.findMany({
            where: {
                ...regionId && {
                    regionId
                },
...
async function POST(request) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].city.findUnique({
            where: {
                name_regionId: {
                    name: data.name,
        ...
        const city = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].city.create({
            data: {
                name: data.name,
                regionId: data.regionId,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(city, {
            status: 201
        });
    } catch (error) {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="812b0bcd-eeeb-5b4d-aff7-60636318183a")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__be42cedf._.js.map
//# debugId=812b0bcd-eeeb-5b4d-aff7-60636318183a
