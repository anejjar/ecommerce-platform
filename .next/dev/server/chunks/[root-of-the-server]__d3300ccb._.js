...
async function GET(request) {
    try {
        ...
        const enabled = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$features$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFeatureEnabled"])('analytics_dashboard');
        if (!enabled) {
        ...
        const [totalRevenue, totalOrders, totalCustomers, recentOrders, revenueByDay, topProducts, ordersByStatus, averageOrderValue, conversionData] = await Promise.all([
            // Total Revenue
      ...
      `,
            ...
            // Orders by Status
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.groupBy({
                by: [
                    'status'
                ],
                where: {
        ...
        const previousRevenue = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.aggregate({
            where: {
                paymentStatus: 'PAID',
                createdAt: {
        ...
        const previousOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
            where: {
                createdAt: {
                    gte: previousStartDate,
                    lt: startDate
        ...
        const currentRevenue = totalRevenue._sum.total ? Number(totalRevenue._sum.total) : 0;
        const prevRevenue = previousRevenue._sum.total ? Number(previousRevenue._sum.total) : 0;
        ...
        const analytics = {
            summary: {
                ...
                averageOrderValue: averageOrderValue._avg.total ? Number(averageOrderValue._avg.total) : 0,
                conversionRate: 0
            },
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="abb0bc6a-780e-58d0-b82d-7e1d35d3964d")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__d3300ccb._.js.map
//# debugId=abb0bc6a-780e-58d0-b82d-7e1d35d3964d
