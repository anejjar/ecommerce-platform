...
"[project]/src/app/api/products/[id]/images/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const images = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productImage.findMany({
            where: {
                productId: id
            },
            orderBy: {
...
async function POST(request, { params }) {
    try {
        ...
        const lastImage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productImage.findFirst({
            where: {
                productId: id
            },
            orderBy: {
        ...
        const image = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productImage.create({
            data: {
                url,
                alt: alt || '',
                position,
...
async function PATCH(request, { params }) {
    try {
        ...
        // Update positions
        await Promise.all(images.map((img)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].productImage.update({
                where: {
                    id: img.id
                },
                data: {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="6abc832d-c132-5ce8-82a7-2b674e667d47")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__3b336ed7._.js.map
//# debugId=6abc832d-c132-5ce8-82a7-2b674e667d47
