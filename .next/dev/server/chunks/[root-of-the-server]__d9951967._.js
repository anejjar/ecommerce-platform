...
"[project]/src/app/api/admin/templates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (isActive) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].template.updateMany({
                where: {
                    type
                },
                data: {
        ...
        const template = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].template.create({
            data: {
                name,
                type,
                content,
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="dd24a3a0-af4a-5ff5-a6e2-7aba597d1ab3")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__d9951967._.js.map
//# debugId=dd24a3a0-af4a-5ff5-a6e2-7aba597d1ab3
