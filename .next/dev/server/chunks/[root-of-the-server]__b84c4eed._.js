...
"[project]/src/app/api/wishlist/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const wishlistItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].wishlistItem.findMany({
            where: {
                userId: user.id
            },
            include: {
...
async function POST(request) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].wishlistItem.findUnique({
            where: {
                userId_productId: {
                    userId: user.id,
                    productId
        ...
        // Add to wishlist
        const wishlistItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].wishlistItem.create({
            data: {
                userId: user.id,
                productId
            },
        ...
        const item = {
            ...
            product: {
                ...
                comparePrice: wishlistItem.product.comparePrice ? wishlistItem.product.comparePrice.toString() : null
            }
        };
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].wishlistItem.delete({
            where: {
                userId_productId: {
                    userId: user.id,
                    productId
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="21cc8b46-36c1-5e79-8772-b942acbd7c4e")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__b84c4eed._.js.map
//# debugId=21cc8b46-36c1-5e79-8772-b942acbd7c4e
