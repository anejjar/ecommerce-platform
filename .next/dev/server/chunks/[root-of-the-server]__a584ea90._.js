...
"[project]/src/app/api/refunds/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateRMANumber() {
    ...
    const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.count();
...
async function GET(request) {
    try {
        ...
        const enabled = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$features$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFeatureEnabled"])('refund_management');
        if (!enabled) {
        ...
        const refunds = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.findMany({
            where: status ? {
                status: status
            } : undefined,
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(refunds);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const existingRefund = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.findFirst({
            where: {
                orderId,
                status: {
                    in: [
        ...
        for (const item of items){
            ...
            const itemRefundAmount = Number(orderItem.price) * item.quantity;
        ...
        // Create refund
        const refund = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refund.create({
            data: {
                rmaNumber,
                status: 'PENDING',
                reason,
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                ...
                html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refundRequestedEmailCustomer"])(order.orderNumber, rmaNumber, refundAmount.toFixed(2), reason)
            });
        } catch (emailError) {
        ...
        try {
            ...
            if (adminEmail) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                    ...
                    html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminNewRefundRequestEmail"])(order.orderNumber, rmaNumber, user.name || user.email, user.email, refundAmount.toFixed(2), reason, reasonDetails)
                });
            }
        } catch (emailError) {
            console.error('Failed to send admin refund email:', emailError);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(refund);
    } catch (error) {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="25dc3a67-d458-5902-848a-56e609a8ddc4")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__a584ea90._.js.map
//# debugId=25dc3a67-d458-5902-848a-56e609a8ddc4
