...
"[project]/src/app/api/admin/flash-sales/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const flashSale = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flashSale.findUnique({
            where: {
                id
            },
            include: {
...
async function PUT(request, { params }) {
    try {
        ...
        const { name, description, discountType, discountValue, startDate, endDate, status, isActive, priority, bannerImage, bannerText, productIds, categoryIds } = body;
        // Validation
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flashSale.delete({
            where: {
                id
            }
        });
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="13a7b4b6-bf16-549d-a31f-e48cbef7c082")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__d2d8c663._.js.map
//# debugId=13a7b4b6-bf16-549d-a31f-e48cbef7c082
