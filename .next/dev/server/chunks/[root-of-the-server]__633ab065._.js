...
"[project]/src/app/api/account/delete-request/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const deletionRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountDeletionRequest.findUnique({
            where: {
...
async function POST(request) {
    try {
        ...
        const existingRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountDeletionRequest.findUnique({
            where: {
                userId: session.user.id
            }
        });
        ...
        const pendingOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.count({
            where: {
                userId: session.user.id,
                status: {
                    in: [
        ...
        const deletionRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountDeletionRequest.create({
            data: {
                userId: session.user.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(deletionRequest, {
            status: 201
        });
    } catch (error) {
...
async function DELETE() {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountDeletionRequest.update({
            where: {
                userId: session.user.id
            },
            data: {
...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d4aa61e5-52ee-5b57-85e1-10a481d5ede7")}catch(e){}}();
//# sourceMappingURL=%5Broot-of-the-server%5D__633ab065._.js.map
//# debugId=d4aa61e5-52ee-5b57-85e1-10a481d5ede7
