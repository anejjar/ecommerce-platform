!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="feff4f1c-0ec6-5093-bd23-b5f2b39eb238")}catch(e){}}();
module.exports = [
...
"[project]/src/hooks/useLandingPages.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/admin/(protected)/cms/landing-pages/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLandingPages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useLandingPages.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function NewLandingPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const page = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLandingPages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createLandingPage"])(formData);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success('Landing page created successfully');
            router.push(`/admin/cms/landing-pages/${page.id}/editor`);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(error.message || 'Failed to create landing page');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_a0fa48d2._.js.map
//# debugId=feff4f1c-0ec6-5093-bd23-b5f2b39eb238
